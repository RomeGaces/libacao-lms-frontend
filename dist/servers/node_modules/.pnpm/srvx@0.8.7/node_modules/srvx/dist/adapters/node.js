import { createWaitUntil, fmtURL, printListening, resolvePortAndHost, resolveTLSOptions } from "../_chunks/_utils-DRF_4b_y.js";
import { wrapFetch } from "../_chunks/_middleware-BvRR7B4M.js";
import { FastURL } from "../_chunks/_url-CdE4ce6F.js";
import { splitSetCookieString } from "../../../../../cookie-es@2.0.0/node_modules/cookie-es/dist/index.js";
import { NodeRequestHeaders, NodeResponse, kNodeInspect } from "../_chunks/response-Ca-wGejU.js";
import { errorPlugin } from "../_chunks/_plugins-DOhVIkXu.js";

//#region node_modules/.pnpm/srvx@0.8.7/node_modules/srvx/dist/adapters/node.mjs
	...
	const _Request = class Request {
		...
		get _hasBody() {
			...
			if (!Number.parseInt(this._node.req.headers["content-length"] || "")) {
				if (!(this._node.req.headers["transfer-encoding"] || "").split(",").map((e) => e.trim()).filter(Boolean).includes("chunked")) {
					this.#hasBody = false;
					return false;
				}
			}
...
var NodeServer = class {
	...
	constructor(options) {
		...
		if (this.options.node?.http2 ?? this.#isSecure) if (this.#isSecure) {

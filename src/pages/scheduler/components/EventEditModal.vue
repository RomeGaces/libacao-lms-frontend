...
watch(
    ...
    (val) => {
        ...
        editForm.subject_id = val.subject_id ?? undefined;
        editForm.professor_id = val.professor_id ?? undefined;
        editForm.building = val.building ?? undefined;
        editForm.room_id = val.room_id ?? undefined;
        editForm.day_of_week = val.day_of_week ?? undefined;
        editForm.start_time = val.start_time;
        editForm.end_time = val.end_time;
    },
    { immediate: true }
);
</script>
